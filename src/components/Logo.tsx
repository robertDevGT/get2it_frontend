  ...
  return (
    <Link to={'/'}>
      <svg width={width} height={height} viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="90" y="50" font-family="Arial, sans-serif" font-size="40" font-weight="600" fill="#28B463">ETIT</text>

        <text x="90" y="90" font-family="Arial, sans-serif" font-size="35" font-weight="500" fill="#2E4053">DONE</text>
      </svg>
    </Link>
